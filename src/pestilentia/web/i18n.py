...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "nav_victims": {"en": "Victims", "it": "Vittime"},
    "nav_adversaries": {"en": "Adversaries", "it": "Avversari"},
    "nav_cyberattacks": {"en": "Cyberattacks", "it": "Cyberattacchi"},
    "nav_articles": {"en": "Articles", "it": "Articoli"},
    "nav_campaigns": {"en": "Campaigns", "it": "Campagne"},
    "nav_attack": {"en": "ATT&CK", "it": "ATT&CK"},
    "nav_map": {"en": "Map", "it": "Mappa"},
    "nav_btc": {"en": "BTC Explorer", "it": "Esplora BTC"},
    "nav_watchlist": {"en": "Watchlist", "it": "Watchlist"},
    "nav_pipeline": {"en": "Pipeline", "it": "Pipeline"},
    "nav_faq": {"en": "FAQ", "it": "FAQ"},
    "nav_settings": {"en": "Settings", "it": "Impostazioni"},
    "sign_in": {"en": "Sign in", "it": "Accedi"},
    "sign_out": {"en": "Sign out", "it": "Esci"},
    "username_ph": {"en": "Username", "it": "Nome utente"},
    "password_ph": {"en": "Password", "it": "Password"},
    "search_ph": {"en": "Search...", "it": "Cerca..."},
    "signin_hint": {
        "en": "Sign in to unlock the full platform.",
        "it": "Accedi per sbloccare la piattaforma completa.",
    },
    "hdr_victims": {"en": "Victims", "it": "Vittime"},
    "hdr_adversaries": {"en": "Adversaries", "it": "Avversari"},
    "hdr_cyberattacks": {"en": "Cyberattacks", "it": "Cyberattacchi"},
    "hdr_btc": {"en": "BTC Address Explorer", "it": "Esplora indirizzi BTC"},
    "hdr_map": {"en": "Geographic Distribution", "it": "Distribuzione geografica"},
    "hdr_pipeline": {"en": "Pipeline Status", "it": "Stato pipeline"},
    "hdr_search": {"en": "Search", "it": "Ricerca"},
    "hdr_settings": {"en": "Settings", "it": "Impostazioni"},
    "hdr_watchlist": {"en": "Watchlist", "it": "Watchlist"},
    "hdr_faq": {"en": "Frequently asked questions", "it": "Domande frequenti"},
    "hdr_404": {"en": "404 — Not Found", "it": "404 — Pagina non trovata"},
    "hdr_articles": {"en": "Articles", "it": "Articoli"},
    "hdr_campaigns": {"en": "Campaigns", "it": "Campagne"},
    "hdr_attack": {"en": "ATT&CK Coverage", "it": "Copertura ATT&CK"},
    "word_ingested": {"en": "ingested", "it": "ingeriti"},
    "with_full_text": {"en": "with full text", "it": "con testo integrale"},
    "multi_article_groups": {"en": "multi-article groups", "it": "gruppi multi-articolo"},
    "word_standalone": {"en": "standalone", "it": "singoli"},
    "articles_examined": {"en": "articles examined", "it": "articoli esaminati"},
    "word_techniques": {"en": "techniques", "it": "tecniche"},
    "tab_profile": {"en": "Profile", "it": "Profilo"},
    "tab_users": {"en": "Users", "it": "Utenti"},
    "tab_activity": {"en": "Activity", "it": "Attività"},
    "tab_sources": {"en": "Sources", "it": "Fonti"},
    "tab_keys": {"en": "Service keys", "it": "Chiavi servizi"},
